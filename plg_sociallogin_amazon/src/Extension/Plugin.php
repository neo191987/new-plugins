...
namespace Joomla\Plugin\Sociallogin\Amazon\Extension;
...
use Joomla\Plugin\Sociallogin\Amazon\Integration\OAuth as AmazonOAuth;
use Joomla\Plugin\Sociallogin\Amazon\Integration\UserQuery;
    ...
    public function init(): void {
      ...
      protected function getConnector(): AmazonOAuth {
          if (is_null($this->connector)) {
            ...
            $this->connector = new AmazonOAuth($options, $httpClient, $this->getApplication()->input, $this->getApplication());
