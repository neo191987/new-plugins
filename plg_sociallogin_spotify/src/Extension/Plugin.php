...
namespace Joomla\Plugin\Sociallogin\Spotify\Extension;
...
use Joomla\Plugin\Sociallogin\Spotify\Integration\OAuth as SpotifyOAuth;
use Joomla\Plugin\Sociallogin\Spotify\Integration\UserQuery;
    ...
    public function init(): void {
      ...
      protected function getConnector(): SpotifyOAuth {
          if (is_null($this->connector)) {
            ...
            $this->connector = new SpotifyOAuth($options, $httpClient, $this->getApplication()->input, $this->getApplication());
